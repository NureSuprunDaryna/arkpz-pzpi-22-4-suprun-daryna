...
namespace Server.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterModel model)
        {
            ...
            HttpContext.Session.SetString("UserId", newUser.Id); // Збереження userId у сесії
            HttpContext.Session.SetString("UserRole", newUser.Role); // Збереження ролі у сесії
        ...
        public async Task<IActionResult> Login([FromBody] LoginModel viewModel)
        {
            ...
            HttpContext.Session.SetString("UserRole", user.Role); // Збереження ролі у сесії
        ...
        public async Task<IActionResult> UpdateUserRoleDirectly(string userId, [FromBody] UpdateRoleModel model)
        {
            ...
            {
                _logger.LogError("Failed to remove current roles for user with ID {UserId}.", userId);
            ...
            {
                _logger.LogError("Failed to add new role for user with ID {UserId}.", userId);
            ...
            {
                _logger.LogError("Failed to update user entity for user with ID {UserId}.", userId);
                return BadRequest("Failed to sync user role.");
            }

            _logger.LogInformation("User with ID {UserId} role updated to {NewRole} by admin {AdminId}.", userId, model.NewRole, admin.Id);
